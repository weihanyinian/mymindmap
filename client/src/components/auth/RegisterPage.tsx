...
import { Brain, Lock, User, ArrowRight, Globe } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-animated relative overflow-hidden">
      <div className="floating-shape w-96 h-96 bg-primary-300 top-0 left-1/4" style={{ animationDelay: '0s' }} />
      <div className="floating-shape w-80 h-80 bg-accent-300 -bottom-10 -right-10" style={{ animationDelay: '-3s' }} />
      <div className="floating-shape w-72 h-72 bg-indigo-200 bottom-1/4 left-0" style={{ animationDelay: '-5s' }} />
      ...
      <div className="w-full max-w-md px-4 relative z-10 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2 text-sm">{t.auth.registerTitle}</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input id="username" type="text" value={username} onChange={(e) => setUsername(e.target.value)}
                className="input-field pl-10" placeholder={t.auth.usernamePlaceholder} required minLength={2} maxLength={30} autoFocus />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)}
                className="input-field pl-10" placeholder={t.auth.passwordMin} required minLength={6} />
            </div>
          </div>
